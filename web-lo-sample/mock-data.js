/**
 * mock-data.js — Données de démo Live Objects
 * Structures fidèles à l'API réelle LO (v2026.2.0)
 */
...
export const MOCK_DEVICES = [
  {
    ...
    type: 'MQTT',
    status: {
      connectivity: { value: 'OFFLINE', since: '2026-02-28T14:23:11Z' },
    },
    interfaces: [{ connector: 'mqtt', nodeId: 'sensor-temp-paris-01' }],
    properties: {
      firmware: '2.1.4',
      model: 'ST-100',
      location: 'Paris, Bâtiment A, RDC',
    },
  ...
  },
  {
    ...
    type: 'MQTT',
    status: {
      connectivity: { value: 'ONLINE', since: '2026-03-01T07:12:00Z' },
    },
    interfaces: [{ connector: 'mqtt', nodeId: 'sensor-hum-lyon-03' }],
    properties: {
      firmware: '2.1.4',
      model: 'SH-200',
      location: 'Lyon, Site B, Externe',
    },
  ...
  },
  {
    ...
    type: 'LORA',
    status: {
      connectivity: { value: 'ONLINE', since: '2026-03-01T00:00:00Z' },
    },
    interfaces: [{ connector: 'lora', nodeId: 'gw-bordeaux-lora-01' }],
    properties: {
      firmware: '3.0.1',
      model: 'GW-LR8',
      location: 'Bordeaux, Tour Alpha',
    },
  ...
  },
  {
    ...
    type: 'MQTT',
    status: {
      connectivity: { value: 'OFFLINE', since: '2026-02-25T09:00:00Z' },
    },
    interfaces: [{ connector: 'mqtt', nodeId: 'actuator-door-nice-07' }],
    properties: {
      firmware: '1.8.2',
      model: 'AC-DRV3',
      location: 'Nice, Entrée Principale',
    },
  ...
  },
  {
    ...
    type: 'LWM2M',
    status: {
      connectivity: { value: 'ONLINE', since: '2026-03-01T08:30:00Z' },
    },
...
// ---------------------------------------------------------------------------
// Audit Logs — codes d'erreur réalistes Live Objects
// ---------------------------------------------------------------------------
export const MOCK_AUDIT_LOGS = {
  'urn:lo:nsid:mqtt:sensor-temp-paris-01': [
    {
      id: 'log-001',
      timestamp: '2026-02-28T14:23:11Z',
      ...
      details: {
        ...
        connector: 'mqtt',
        clientId: 'sensor-temp-paris-01',
        reason: 'API key invalid or revoked',
      },
    },
    {
      id: 'log-002',
      timestamp: '2026-02-28T14:20:05Z',
      type: 'DEVICE_CONNECTION',
      level: 'ERROR',
      message: 'Connection refused: bad username or password',
      details: {
    ...
    },
    {
      ...
      details: {
        errorCode: 'MQTT_DISCONNECT_NORMAL',
        connector: 'mqtt',
        clientId: 'sensor-temp-paris-01',
      },
    },
  ...
  'urn:lo:nsid:mqtt:actuator-door-nice-07': [
    {
      ...
      details: {
        ...
        connector: 'mqtt',
        clientId: 'actuator-door-nice-07',
        certExpiry: '2026-02-24T23:59:59Z',
      },
    },
    {
      id: 'log-011',
      timestamp: '2026-02-25T08:58:00Z',
      type: 'DEVICE_CONNECTION',
      level: 'ERROR',
      message: 'TLS handshake failed: certificate expired',
      details: {
  ...
  'urn:lo:nsid:mqtt:sensor-hum-lyon-03': [
    ...
    {
      id: 'log-021',
      timestamp: '2026-03-01T07:12:00Z',
      type: 'DEVICE_CONNECTION',
      level: 'INFO',
      message: 'Device connected successfully',
...
// ---------------------------------------------------------------------------
// Last messages (data payloads)
// ---------------------------------------------------------------------------
export const MOCK_MESSAGES = {
  'urn:lo:nsid:mqtt:sensor-temp-paris-01': [
    {
      id: 'msg-001',
      timestamp: '2026-02-28T14:14:50Z',
      topic: 'dev/v1/data/new',
      value: { temperature: 21.3, unit: 'celsius', battery: 78 },
    },
    {
      id: 'msg-002',
      timestamp: '2026-02-28T14:09:50Z',
      topic: 'dev/v1/data/new',
      value: { temperature: 21.1, unit: 'celsius', battery: 78 },
    },
  ],
  'urn:lo:nsid:mqtt:sensor-hum-lyon-03': [
    {
      ...
      timestamp: '2026-03-01T10:45:00Z',
      topic: 'dev/v1/data/new',
      value: { humidity: 65.4, unit: 'percent', battery: 92 },
    },
  ],
  'urn:lo:nsid:lwm2m:tracker-fleet-002': [
    {
      ...
      timestamp: '2026-03-01T10:52:00Z',
      topic: 'dev/v1/data/new',
      value: { latitude: 48.8566, longitude: 2.3522, speed: 42, altitude: 35 },
    },
  ],
  'urn:lo:nsid:lora:gw-bordeaux-lora-01': [],
  'urn:lo:nsid:mqtt:actuator-door-nice-07': [],
